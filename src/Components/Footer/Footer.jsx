const Footer = () => {
    return (
        ...
        // <footer className="bg-[#0D1230] ">
        // </footer>

        <footer className="px-4 divide-y bg-[#0D1230] dark:text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-4 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
