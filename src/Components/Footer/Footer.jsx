const Footer = () => {
    return (
        <footer className="px-4 bg-[#0D1230] text-white">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="lg:w-1/3 flex justify-center lg:justify-start">
                    <a rel="noopener noreferrer" href="#" className="flex space-x-3">
                        <div className="flex items-center justify-center w-20 h-20">
                            <img
                                src="https://i.ibb.co.com/fSRyxtf/Whats-App-Image-2025-01-25-at-13-27-25-689d585d-removebg-preview.png"
                                alt="Logo"
                            />
                        </div>
                    </a>
                ...
                {/* Links Section */}
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-8 lg:w-2/3">
